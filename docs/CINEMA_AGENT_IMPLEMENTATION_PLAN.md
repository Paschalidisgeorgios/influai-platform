...
| **Future (Export)** | PDF/ZIP export packages should include campaign brief, prompts, captions, social schedule and brand safety checklist — generated client-side or server-side after explicit user action. |
