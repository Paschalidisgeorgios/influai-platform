...
function m(entry: RegistryEntryInput): KreaModelConfig {
  ...
  const availability =
    internalModel.startsWith("pending/") ? "not_configured" : entry.availability;
  const descriptionEn =
...
export const KREA_MODEL_REGISTRY_ENTRIES: readonly KreaModelConfig[] = [
  ...
  m({
    ...
    availability: "experimental",
    outputType: "image",
    requiredInputs: ["prompt", "referenceImageUrl"],
  }),

  // —— Ideogram / Qwen / Luma / Z ——
  m({
    id: "ideogram-20a-turbo",
  ...
  m({
    ...
    validation: {
      ...
      lastCheckedAt: "2026-05-30T21:00:00.000Z",
  ...
  m({
    ...
    validation: {
      lastStatus: "failed",
      lastErrorCode: "KREA_PLAN_LIMIT",
      lastCheckedAt: "2026-05-30T21:05:00.000Z",
      notes: "Krea returned 402. This model may require a higher Krea API plan.",
    },
  }),
  ...
  m({
    ...
    descriptionEn:
      "Runway Gen-4 Aleph — portrait motion transfer via init_video + init_image_url (official Krea path video/runway/aleph).",
    descriptionDe:
      "Runway Gen-4 Aleph — Portrait-Motion-Transfer über init_video + init_image_url (offizieller Krea-Pfad video/runway/aleph).",
    credits: 30,
    availability: "failed_validation",
    outputType: "video",
  ...
  m({
    ...
    validation: {
      lastStatus: "failed",
      lastErrorCode: "KREA_PLAN_LIMIT",
      lastCheckedAt: "2026-05-30T21:38:00.000Z",
      notes: "Krea returned 402. This model may require a higher Krea API plan.",
    },
  }),
  m({
  ...
  m({
    ...
    provider: "krea",
    model: "topaz/generative-enhance",
    category: "enhancer",
    endpointKind: "enhance",
    tools: ["enhancer"],
    capabilities: ["enhance", "upscale"],
    ...
    validation: {
      lastStatus: "passed",
      lastCheckedAt: "2026-05-30T22:00:00.000Z",
      notes: "Live validation passed with current Krea API plan.",
    },
  }),
