...
const AUTH_COPY = {
  en: {
    ...
    subtitleLogin: "Sign in to continue creating.",
    subtitleRegister: "Start free — no credit card required.",
    email: "Work email",
    password: "Password",
  ...
  de: {
    ...
    subtitleLogin: "Melde dich an und erstelle weiter.",
    subtitleRegister: "Kostenlos starten — keine Kreditkarte nötig.",
    email: "E-Mail",
    password: "Passwort",
