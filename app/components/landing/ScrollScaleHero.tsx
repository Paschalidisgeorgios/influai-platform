      ...
      <div className="sticky top-0 flex h-screen items-center justify-center overflow-hidden px-6">
        {prefersReducedMotion ? (
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-5xl font-black tracking-tighter text-[#d8ad5f] md:text-7xl">
              {title}
            </h2>
            <div className="mt-10 space-y-4">
              <p className="text-2xl font-bold text-white md:text-3xl">{nextTitle}</p>
          ...
          <>
            <motion.h2
              ...
              className="whitespace-nowrap text-center text-6xl font-black tracking-tighter text-[#d8ad5f] md:text-8xl lg:text-[10rem]"
            >
              {title}
            </motion.h2>
