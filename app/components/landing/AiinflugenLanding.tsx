...
function TypewriterText({
  ...
  return (
    <span className={className}>
      {text}
      <span
        className="ml-[2px] inline-block w-[2px] animate-pulse bg-current align-middle"
        style={{ height: "0.85em" }}
        aria-hidden
      />
    </span>
...
export default function AiinflugenLanding({
  ...
  const text = {
    en: {
      ...
      signIn: "Sign in",
      openApp: "Open Studio",
      label: "InfluExAi ┬À AI Creator Studio",
      title1: "Create campaign-ready",
      title2: "AI visuals",
      gold: "in minutes",
      subtitle:
        "InfluExAi helps creators, brands and businesses generate professional visuals for social media, product campaigns and digital ads ÔÇö with reusable styles, visual modes and a complete asset workflow.",
      ...
      faq: [
        ...
        },
        {
          ...
          a: "Generated assets are saved to your accountÔÇÖs Asset Gallery for easy reuse and download.",
        },
        {
    ...
    de: {
      ...
      creators: "Beispiele",
      signIn: "Einloggen",
      openApp: "Studio ├Âffnen",
      label: "InfluExAi ┬À AI Creator Studio",
      title1: "Kampagnenfertige",
      title2: "KI-Visuals",
      gold: "in Minuten",
      subtitle:
        "InfluExAi hilft Creatorn, Marken und Unternehmen, professionelle Visuals f├╝r Social Media, Produktkampagnen und digitale Werbung zu erstellen ÔÇö mit wiederverwendbaren Styles, visuellen Modi und vollst├ñndigem Asset-Workflow.",
      start: "Jetzt erstellen",
      startCreating: "Jetzt erstellen",
      viewExamples: "Beispiele ansehen",
      explore: "Beispiele ansehen",
      studioTitle: "Ein Studio f├╝r den gesamten Visual-Workflow.",
      studioText:
        "Verwandle Ideen in professionelle Visuals f├╝r Social Media, Produktkampagnen und digitale Werbung ÔÇô mit wiederverwendbaren Styles und vollst├ñndigem Asset-Workflow.",
      toolsTitle: "F├╝r wiederholbaren, markenkonsistenten Output.",
      workflowTitle: "Vom Briefing zu fertigen Assets.",
      examplesTitle: "Kampagnenfertige Beispiele.",
      pricingTitle: "W├ñhle dein Credit-Paket.",
      pricingNote:
        "Credits werden nur beim Generieren verbraucht. Standard-Bilder kosten 1 Credit.",
      secure: "Sichere Zahlung ├╝ber Stripe",
      powered: "Kernfunktionen der Plattform",
      badgeLive: "Live",
      badgeComingSoon: "Demn├ñchst",
      badgePlanned: "Geplant",
      badgeRoadmap: "Roadmap",
      trustTitle: "Trust & FAQ",
      trustSubtitle:
        "Klare Preise, private Assets und ein einfacher Workflow. Hier sind die h├ñufigsten Fragen.",
      faq: [
        {
          q: "Wof├╝r werden Credits genutzt?",
          a: "Credits werden beim Generieren verbraucht. Die Kosten h├ñngen vom Modus ab (im Studio sichtbar).",
        },
        {
        ...
        },
        {
          ...
          a: "Generierte Assets werden in deiner Asset Gallery gespeichert ÔÇô zum Wiederverwenden und Download.",
        },
        {
          q: "Kann ich einen Look f├╝r eine Kampagne wiederverwenden?",
          a: "Ja. Style Profiles speichern Creative Direction (Look, Mood, Styling) f├╝r konsistentere Ergebnisse.",
        },
      ],
    },
  };
  ...
  const tools = [
    {
      ...
      description:
        language === "en"
          ...
          : "Wandle Briefings in kampagnenfertige Visuals um ÔÇô mit gef├╝hrten Modi und Social-Format-Presets.",
      icon: Sparkles,
    },
    {
      ...
      description:
        language === "en"
          ...
          : "Speichere wiederverwendbare Creative Direction (Look, Mood, Styling) f├╝r konsistente Ergebnisse.",
      icon: UserRound,
    },
    {
    ...
    },
    {
      ...
      description:
        language === "en"
          ...
          : "Ergebnisse pr├╝fen, Favoriten speichern und Kampagnenassets herunterladen ÔÇô an einem Ort.",
    ...
    },
    {
      ...
      description:
        language === "en"
          ...
          : "Processing verfolgen, Ergebnisse pr├╝fen und die besten Assets wiederverwenden.",
      icon: Layers,
    },
  ];
  ...
  return (
    <main className={`${bodyFontClass} relative min-h-screen bg-[#0D0D0F] text-white`}>
      <ScrollProgress />
      <FloatingOrbs />
      <CursorGlow />
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <TypewriterText
                words={
                  language === "en"
                    ? ["in minutes", "at scale", "instantly", "for creators"]
                    : ["in Minuten", "skalierbar", "sofort", "für Creators"]
                }
                className="text-[#d8ad5f]"
              />
            </h1>
          ...
          {tools.map((tool, index) => {
            ...
            return (
              <Reveal key={tool.title} delay={index * 120}>
                <TiltCard className="rounded-3xl border border-white/10 bg-white/[0.035] p-6 transition hover:border-[#d8ad5f]/45">
          ...
          {workflow.map((step, index) => {
            ...
            return (
              <Reveal key={step.title} delay={index * 150}>
                <TiltCard className="relative rounded-3xl border border-white/10 bg-white/[0.035] p-7 transition hover:border-[#d8ad5f]/35">
      ...
      <div id="pricing">
        <BrutalistPricingGrid currentLanguage={language} />
      </div>
