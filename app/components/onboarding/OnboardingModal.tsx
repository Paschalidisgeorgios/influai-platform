...
const COPY = {
  en: {
    title: "Welcome to InfluExAi",
    subtitle: "How will you use it? We'll set up your studio.",
    goals: [
  ...
  de: {
    title: "Willkommen bei InfluExAi",
    subtitle: "Wie nutzt du die Plattform? Wir richten dein Studio ein.",
    goals: [
      { id: "creator" as Goal, label: "Content Creator", sub: "TikTok, Instagram, YouTube" },
    ...
    skip: "Überspringen",
    freeNote: "Keine Kreditkarte nötig",
  },
};
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
      ...
      >
        ...
        <button
          ...
          disabled={!selected}
          className="flex w-full items-center justify-center gap-2 rounded-2xl bg-[#d8ad5f] py-3.5 text-sm font-bold text-black transition hover:bg-[#efc777] disabled:cursor-not-allowed disabled:opacity-40"
        >
        ...
        <button
          type="button"
          onClick={() => onComplete("personal")}
          className="mt-2 w-full text-center text-xs text-white/25 transition hover:text-white/50"
        >
          {t.skip}
        </button>
      </motion.div>
